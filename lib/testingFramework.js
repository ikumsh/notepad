...
Test.prototype.changer = function(a, b, c, desc) {
  failMsg = "Expected change of: " + c + ", instead changed by: " + (b - a)
  this.assert((b - a) === c, desc, failMsg)
}
